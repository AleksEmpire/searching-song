...
const Lyric = (props) => {
  ...
  useEffect(() => {
    axios
      .get(
        `https://cors-anywhere.herokuapp.com/http://api.musixmatch.com/ws/1.1/track.lyrics.get?track_id=${props.match.params.id}&apikey=b2f84be3a1532ec4ed99ae249147773b`
      )
      .then((res) => {
        ...
        return axios.get(
          `https://cors-anywhere.herokuapp.com/http://api.musixmatch.com/ws/1.1/track.get?track_id=${props.match.params.id}&apikey=b2f84be3a1532ec4ed99ae249147773b`
        );
      })
      .then((res) => {
